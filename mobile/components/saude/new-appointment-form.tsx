...
import { APPOINTMENT_KIND_LABELS, REMINDER_OFFSET_OPTIONS, type AppointmentKind } from "@/lib/saude";
...
export function NewAppointmentForm({
  ...
  const [kind, setKind] = useState<AppointmentKind>(initial?.kind ?? "consulta");
  ...
  const [reminderOffset, setReminderOffset] = useState<number | null>(
    initial?.reminderOffsetMinutes ?? 60
  );
  ...
  return (
    ...
    >
      <TextInput
        ...
        placeholder="Título (ex: Cardiologista, Terapia)"
      ...
      <TextInput
        ...
        placeholder="Profissional/local (opcional)"
        placeholderTextColor={tokens.textMuted}
        style={inputStyle}
      />
